...
import { executeSwiftCli, readImageAsBase64 } from "../../../src/utils/peepit-cli";
...
const MOCK_TEMP_IMAGE_DIR = "/tmp/peepit-img-XXXXXX";
const MOCK_SAVED_FILE_PATH = "/tmp/peepit-img-XXXXXX/capture.png";
...
describe("Image Tool", () => {
  ...
  describe("imageToolHandler - Capture and Analyze", () => {
    ...
    beforeEach(() => {
      ...
      process.env.PEEPIT_AI_PROVIDERS = "ollama/llava:latest";
    });
    ...
    it("should analyze all images when capture results in multiple files", async () => {
      ...
      const mockFile1: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/window1.png",
        mime_type: "image/png",
        item_label: "Window 1",
      };
      const mockFile2: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/window2.png",
        mime_type: "image/png",
        item_label: "Window 2",
      };
      const mockResponse = {
    ...
    it("should use window titles for analysis labels when capturing multiple windows", async () => {
      ...
      const mockFile1: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/chrome_window1.png",
        mime_type: "image/png",
      ...
      const mockFile2: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/chrome_window2.png", 
        mime_type: "image/png",
        item_label: "Google Chrome",
    ...
    it("should fallback to window index when no window title is available", async () => {
      ...
      const mockFile1: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/app_window1.png",
        mime_type: "image/png",
        item_label: "Some App",
        window_index: 0,
        window_id: 123,
      ...
      const mockFile2: SavedFile = {
        path: "/tmp/peepit-img-XXXXXX/app_window2.png", 
        mime_type: "image/png",
        item_label: "Some App",
        window_index: 1,
        window_id: 124,
