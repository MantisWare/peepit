...
import { initializeSwiftCliPath, executeSwiftCli, readImageAsBase64 } from "../../src/utils/peepit-cli";
import { mockSwiftCli } from "../mocks/peepit-cli.mock";
...
const MOCK_TEMP_DIR = "/private/var/folders/xyz/T/peepit-temp-12345";
...
describeSwiftTests("Image Tool Integration Tests", () => {
  ...
  describe("Output Handling", () => {
    ...
    it("should return an error if the Swift CLI fails", async () => {
      // Ensure PEEPIT_DEFAULT_SAVE_PATH is not set for this test
      delete process.env.PEEPIT_DEFAULT_SAVE_PATH;
  ...
  describe("Environment variable handling", () => {
    it("should use PEEPIT_DEFAULT_SAVE_PATH when no path provided and no question", async () => {
      const MOCK_DEFAULT_PATH = "/default/save/path";
      process.env.PEEPIT_DEFAULT_SAVE_PATH = MOCK_DEFAULT_PATH;
    ...
    it("should NOT use PEEPIT_DEFAULT_SAVE_PATH when question is provided", async () => {
