...
# Test publishing script for PeepIt MCP
...
# Install the package
echo "📦 Installing @mantisware/peepit-mcp from local registry..."
npm install @mantisware/peepit-mcp --registry http://localhost:4873/
...
const server = spawn('npx', ['@mantisware/peepit-mcp'], {
