...
PROJECT_ROOT_REL=".." # Relative path to project root from peepit-cli
PROJECT_ROOT=$(cd "$(dirname "$0")/$PROJECT_ROOT_REL" && pwd)
SWIFT_PROJECT_PATH="$PROJECT_ROOT/peepit-cli"
FINAL_BINARY_NAME="peepit"
...
VERSION_SWIFT_PATH="$SWIFT_PROJECT_PATH/Sources/peepit/Version.swift"
