import AppKit
import Foundation
@testable import peepit
import Testing

// MARK: - Local Only Tests

// These tests require the PeepItTestHost app to be running and user interaction
...
struct LocalIntegrationTests {
    ...
    static let testHostBundleId = "com.mantisware.peepit.testhost"
    static let testHostAppName = "PeepItTestHost"
    static let testWindowTitle = "PeepIt Test Host"
    ...
    private func buildTestHost() throws -> String {
        ...
        process.currentDirectoryURL = URL(fileURLWithPath: "/Users/mantisware/Projects/PeepIt/peepit-cli/TestHost")
        ...
        return "/Users/mantisware/Projects/PeepIt/peepit-cli/TestHost/.build/debug/PeepItTestHost"
    }
    ...
    func captureTestHostWindow() async throws {
        ...
        let outputPath = "/tmp/peepit-test-window.png"
